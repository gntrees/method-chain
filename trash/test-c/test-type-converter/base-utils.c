...
static void print_value(FILE *out, const cJSON *node, int depth)
{
...
SchemaType getSchema_impl(const Builder *b, const char *exportName, const char *importString)
{
...
const char *getJSONSchema_impl(const SchemaType *s)
{
