...
const linguaTunggaStructure: StructureType = {
    structure: {
        ...
        functions: [
            ...
            ltFunction("buffer-new"),
            ltFunction("buffer-append", [arg("value", operatorOperand), arg("text", operatorOperand)]),
            ltFunction("buffer-length", [arg("value", operatorOperand)]),
            ltFunction("buffer-to-string", [arg("value", operatorOperand)]),
            ltFunction("list-new"),
            ltFunction("list-push", [arg("value", operatorOperand), arg("item", operatorOperand)]),
            ltFunction("list-length", [arg("value", operatorOperand)]),
            ltFunction("list-value", [arg("value", operatorOperand)]),
