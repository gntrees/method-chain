 ...
 */
#define isNull() \
    builder_call("is-null", ((ArgumentType[]){  }), 0, 0)

/**
 * @return Builder (function-call) : query-builder
 */
#define isNotNull() \
    builder_call("is-not-null", ((ArgumentType[]){  }), 0, 0)
 ...
 * @return ParseResult
 */
static ParseResult query_builder_parse_impl(Builder builder, ArgumentType *args, size_t count) {
(void)builder; (void)args; (void)count;
...
ArgumentValue asString(ArgumentValue arg) {
  return lt_get(lt_get(arg, v_string("string")), v_string("value"));
}
ArgumentValue identStr(ArgumentValue name) {
  return lt_str_concat(quote, lt_str_concat(lt_replace(name, quote, lt_str_concat(quote, quote)), quote));
}
ArgumentValue literalOf(ArgumentValue arg) {
  ...
  if (({ ArgumentValue __lt_t = (lt_has(arg, v_string("string"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
    ...
    if (({ ArgumentValue __lt_t = (lt_get(lt_get(arg, v_string("boolean")), v_string("value"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
      ...
      outLiteral = v_string("FALSE");
    }
  }
  else {
    outLiteral = v_string("NULL");
  }
  return outLiteral;
}
ArgumentValue opOf(ArgumentValue n) {
  ArgumentValue o = v_string("");
  if (lt_value_equals(n, v_string("eq"))) {
    o = v_string("=");
  }
  else if (lt_value_equals(n, v_string("gt"))) {
    o = v_string(">");
  }
  else if (lt_value_equals(n, v_string("gte"))) {
    o = v_string(">=");
  }
  else if (lt_value_equals(n, v_string("lt"))) {
    o = v_string("<");
  }
  else if (lt_value_equals(n, v_string("lte"))) {
    o = v_string("<=");
  }
  else if (lt_value_equals(n, v_string("like"))) {
    o = v_string("LIKE");
  }
  else if (lt_value_equals(n, v_string("ilike"))) {
    o = v_string("ILIKE");
  }
  return o;
}
...
ArgumentValue emitIdent(ArgumentValue name) {
  tmp = identStr(name);
  pushSql(tmp);
  pushW(tmp);
  return v_null();
...
ArgumentValue conflictTarget(ArgumentValue arg) {
  ArgumentValue ct = v_string("()");
  if (({ ArgumentValue __lt_t = (lt_has(arg, v_string("chain"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
    ...
    if (!lt_value_equals(tmpRef, v_string(""))) {
      ct = lt_str_concat(v_string("("), lt_str_concat(identStr(tmpRef), v_string(")")));
    }
  }
  else if (({ ArgumentValue __lt_t = (lt_has(arg, v_string("string"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
    ct = lt_str_concat(v_string("("), lt_str_concat(identStr(asString(arg)), v_string(")")));
  }
  return ct;
}
...
ArgumentValue emitOrderItem(ArgumentValue item) {
  ...
  if (({ ArgumentValue __lt_t = (lt_has(item, v_string("chain"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
    ...
    for (size_t onIndex = 0; onIndex < onArray.count; onIndex++) {
      ...
      ArgumentValue onn = normName(lt_get(lt_get(on, v_string("functionCall")), v_string("name")));
      if (lt_value_equals(onn, v_string("asc"))) {
        dir = v_string(" ASC");
      }
      else if (lt_value_equals(onn, v_string("desc"))) {
        dir = v_string(" DESC");
      }
      else if (lt_value_equals(onn, v_string("col")) || lt_value_equals(onn, v_string("table"))) {
        ordName = asString(lt_get(lt_index(lt_get(lt_get(on, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")));
      }
    }
  }
  if (!lt_value_equals(ordName, v_string(""))) {
    tmp = identStr(ordName);
    orderSql = lt_str_concat(orderSql, lt_str_concat(tmp, dir));
    orderW = lt_str_concat(orderW, lt_str_concat(tmp, dir));
  }
  return v_null();
}
ArgumentValue emitOrderList(ArgumentValue arg) {
  ArgumentValue firstOrder = v_bool(true);
  ...
  for (size_t itemIndex = 0; itemIndex < itemArray.count; itemIndex++) {
    ...
    if (lt_value_equals(firstOrder, v_bool(false))) {
      orderSql = lt_str_concat(orderSql, v_string(", "));
      orderW = lt_str_concat(orderW, v_string(", "));
    }
    firstOrder = v_bool(false);
    emitOrderItem(item);
  }
  return v_null();
}
ArgumentValue flushOrder(void) {
  if (({ ArgumentValue __lt_t = (hasOrder); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
    ...
    pushW(v_string("BY"));
    tmp = orderSql;
    if (!lt_value_equals(tmp, v_string(""))) {
      pushSql(tmp);
    }
    tmp2 = orderW;
    if (!lt_value_equals(tmp2, v_string(""))) {
      pushW(tmp2);
    }
    hasOrder = v_bool(false);
  }
  return v_null();
}
ArgumentValue dialectNodeArray = lt_get(lt_get(lt_get(lt_get(root, v_string("schema")), v_string("chain")), v_string("chain")), v_string("values"));
for (size_t dialectNodeIndex = 0; dialectNodeIndex < dialectNodeArray.count; dialectNodeIndex++) {
  ArgumentValue dialectNode = ((const ArgumentValue *)dialectNodeArray.as.data)[dialectNodeIndex];
  if (lt_value_equals(normName(lt_get(lt_get(dialectNode, v_string("functionCall")), v_string("name"))), v_string("setdialect"))) {
    dialect = lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(dialectNode, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("string")), v_string("value"));
  }
}
if (lt_value_equals(dialect, v_string(""))) {
  ({ ArgumentValue __lt_m = (v_string("query-builder parse: setDialect(...) must be called before parse()")); fail("%s", lt_as_string(&__lt_m)); });
}
else if (!lt_value_equals(dialect, v_string("postgres")) && !lt_value_equals(dialect, v_string("mysql"))) {
  ({ ArgumentValue __lt_m = (lt_str_concat(v_string("query-builder parse: unsupported dialect "), dialect)); fail("%s", lt_as_string(&__lt_m)); });
}
if (lt_value_equals(dialect, v_string("mysql"))) {
  quote = v_string("`");
}
else {
  quote = v_string("\"");
...
ArgumentValue renderNodes(ArgumentValue nodes, ArgumentValue mode) {
  ...
  ArgumentValue savedHasOrder = v_bool(false);
  ...
  ArgumentValue first = v_bool(true);
  ArgumentValue left = v_string("");
  ArgumentValue hasLeft = v_bool(false);
      ...
      if (({ ArgumentValue __lt_t = (lt_has(node, v_string("functionCall"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
        ...
        if (lt_value_equals(nameNorm, v_string("setdialect"))) {
          ...
          if (lt_value_equals(nameNorm, v_string("with"))) {
            ...
            if (lt_value_equals(withFirst, v_bool(false))) {
              sql = lt_buf_append(sql, v_string(","));
              wsql = lt_buf_append(wsql, v_string(","));
            }
            else {
              withFirst = v_bool(false);
          ...
          else if (lt_value_equals(nameNorm, v_string("transaction"))) {
            pushSql(v_string("BEGIN"));
            pushW(v_string("BEGIN"));
            ArgumentValue txnFirst = v_bool(true);
            ArgumentValue txnItemArray = itemsOf(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")));
            for (size_t txnItemIndex = 0; txnItemIndex < txnItemArray.count; txnItemIndex++) {
              ...
              if (lt_value_equals(txnFirst, v_bool(false))) {
                sql = lt_buf_append(sql, v_string(";"));
                wsql = lt_buf_append(wsql, v_string(";"));
              }
              txnFirst = v_bool(false);
              ...
              else if (({ ArgumentValue __lt_t = (lt_has(txnItem, v_string("string"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
                pushSql(asString(txnItem));
                pushW(asString(txnItem));
              }
              else {
                if (({ ArgumentValue __lt_t = (lt_has(txnItem, v_string("chain"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
                  tmpRef = isRef(lt_get(lt_get(txnItem, v_string("chain")), v_string("values")));
                  if (!lt_value_equals(tmpRef, v_string(""))) {
                    emitIdent(tmpRef);
                  }
                  else if ((lt_value_equals(firstKind(lt_get(lt_get(txnItem, v_string("chain")), v_string("values"))), v_string("select")) || lt_value_equals(firstKind(lt_get(lt_get(txnItem, v_string("chain")), v_string("values"))), v_string("with"))) || (lt_value_equals(firstKind(lt_get(lt_get(txnItem, v_string("chain")), v_string("values"))), v_string("values")) || (lt_value_equals(firstKind(lt_get(lt_get(txnItem, v_string("chain")), v_string("values"))), v_string("insert")) || (lt_value_equals(firstKind(lt_get(lt_get(txnItem, v_string("chain")), v_string("values"))), v_string("update")) || lt_value_equals(firstKind(lt_get(lt_get(txnItem, v_string("chain")), v_string("values"))), v_string("delete")))))) {
                    savedSql = sql;
                    savedW = wsql;
                    savedOrderSql = orderSql;
                    savedOrderW = orderW;
            ...
            for (size_t itemIndex = 0; itemIndex < itemArray.count; itemIndex++) {
              ArgumentValue item = ((const ArgumentValue *)itemArray.as.data)[itemIndex];
              if (lt_value_equals(firstItem, v_bool(false))) {
                sql = lt_buf_append(sql, v_string(","));
                wsql = lt_buf_append(wsql, v_string(","));
              }
              firstItem = v_bool(false);
              if (({ ArgumentValue __lt_t = (lt_has(item, v_string("chain"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
            ...
            pushW(v_string("SET"));
            ArgumentValue assnFirst = v_bool(true);
            ArgumentValue akArray = lt_keys(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")));
            for (size_t akIndex = 0; akIndex < akArray.count; akIndex++) {
              ArgumentValue ak = ((const ArgumentValue *)akArray.as.data)[akIndex];
              if (lt_value_equals(assnFirst, v_bool(false))) {
                sql = lt_buf_append(sql, v_string(","));
                wsql = lt_buf_append(wsql, v_string(","));
              }
              assnFirst = v_bool(false);
              pushSql(identStr(ak));
              pushW(identStr(ak));
              pushSql(v_string("="));
              pushW(v_string("="));
              if (({ ArgumentValue __lt_t = (lt_has(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
                tmpRef = isRef(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values")));
                if (!lt_value_equals(tmpRef, v_string(""))) {
                  emitIdent(tmpRef);
                }
                else if ((lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("select")) || lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("with"))) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("values")) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("insert")) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("update")) || lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("delete")))))) {
                  savedSql = sql;
                  savedW = wsql;
                  savedOrderSql = orderSql;
                  savedOrderW = orderW;
                  ...
                  emitParam(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), ak));
                }
              }
              else {
                emitParam(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), ak));
            ...
            pushSql(v_string("INSERT"));
            pushW(v_string("INSERT"));
            pushSql(v_string("INTO"));
            pushW(v_string("INTO"));
            if (({ ArgumentValue __lt_t = (lt_has(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("chain"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
              tmpRef = isRef(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("chain")), v_string("values")));
              if (!lt_value_equals(tmpRef, v_string(""))) {
            ...
            pushSql(v_string("("));
            pushW(v_string("("));
            ArgumentValue colFirst = v_bool(true);
            ArgumentValue ckArray = lt_keys(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")));
            for (size_t ckIndex = 0; ckIndex < ckArray.count; ckIndex++) {
              ArgumentValue ck = ((const ArgumentValue *)ckArray.as.data)[ckIndex];
              if (lt_value_equals(colFirst, v_bool(false))) {
                sql = lt_buf_append(sql, v_string(","));
                wsql = lt_buf_append(wsql, v_string(","));
              }
              colFirst = v_bool(false);
              pushSql(identStr(ck));
              pushW(identStr(ck));
            }
            pushSql(v_string(")"));
            ...
            pushSql(v_string("("));
            pushW(v_string("("));
            ArgumentValue valFirst = v_bool(true);
            ArgumentValue vkArray = lt_keys(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")));
            for (size_t vkIndex = 0; vkIndex < vkArray.count; vkIndex++) {
              ArgumentValue vk = ((const ArgumentValue *)vkArray.as.data)[vkIndex];
              if (lt_value_equals(valFirst, v_bool(false))) {
                sql = lt_buf_append(sql, v_string(","));
                wsql = lt_buf_append(wsql, v_string(","));
              }
              valFirst = v_bool(false);
              if (({ ArgumentValue __lt_t = (lt_has(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), vk), v_string("chain"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
                tmpRef = isRef(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), vk), v_string("chain")), v_string("values")));
                if (!lt_value_equals(tmpRef, v_string(""))) {
                  emitIdent(tmpRef);
                }
                else if ((lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), vk), v_string("chain")), v_string("values"))), v_string("select")) || lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), vk), v_string("chain")), v_string("values"))), v_string("with"))) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), vk), v_string("chain")), v_string("values"))), v_string("values")) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), vk), v_string("chain")), v_string("values"))), v_string("insert")) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), vk), v_string("chain")), v_string("values"))), v_string("update")) || lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), vk), v_string("chain")), v_string("values"))), v_string("delete")))))) {
                  savedSql = sql;
                  savedW = wsql;
                  savedOrderSql = orderSql;
                  savedOrderW = orderW;
                  ...
                  emitParam(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), vk));
                }
              }
              else {
                emitParam(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(1)), v_string("argument")), v_string("object")), v_string("value")), vk));
            ...
            pushW(v_string("SET"));
            ArgumentValue assnFirst = v_bool(true);
            ArgumentValue akArray = lt_keys(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("object")), v_string("value")));
            for (size_t akIndex = 0; akIndex < akArray.count; akIndex++) {
              ArgumentValue ak = ((const ArgumentValue *)akArray.as.data)[akIndex];
              if (lt_value_equals(assnFirst, v_bool(false))) {
                sql = lt_buf_append(sql, v_string(","));
              ...
              pushSql(v_string("="));
              pushW(v_string("="));
              if (({ ArgumentValue __lt_t = (lt_has(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
                tmpRef = isRef(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values")));
                if (!lt_value_equals(tmpRef, v_string(""))) {
                  emitIdent(tmpRef);
                }
                else if ((lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("select")) || lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("with"))) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("values")) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("insert")) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("update")) || lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("object")), v_string("value")), ak), v_string("chain")), v_string("values"))), v_string("delete")))))) {
                  savedSql = sql;
                  savedW = wsql;
                  savedOrderSql = orderSql;
                  savedOrderW = orderW;
                  ...
                  emitParam(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("object")), v_string("value")), ak));
                }
              }
              else {
                emitParam(lt_get(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("object")), v_string("value")), ak));
            ...
            pushSql(v_string("VALUES"));
            pushW(v_string("VALUES"));
            ArgumentValue valueRows = itemsOf(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")));
            ArgumentValue valueFirst = v_bool(true);
            if (!lt_value_equals(lt_len(valueRows), v_int(0)) && ({ ArgumentValue __lt_t = (lt_has(lt_index(valueRows, v_int(0)), v_string("array"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
              ArgumentValue tupleArray = valueRows;
              for (size_t tupleIndex = 0; tupleIndex < tupleArray.count; tupleIndex++) {
                ...
                if (lt_value_equals(valueFirst, v_bool(false))) {
                  sql = lt_buf_append(sql, v_string(","));
                  wsql = lt_buf_append(wsql, v_string(","));
                }
                valueFirst = v_bool(false);
                pushSql(v_string("("));
                pushW(v_string("("));
                ArgumentValue itemFirst = v_bool(true);
                ArgumentValue tiArray = itemsOf(tuple);
                for (size_t tiIndex = 0; tiIndex < tiArray.count; tiIndex++) {
                  ArgumentValue ti = ((const ArgumentValue *)tiArray.as.data)[tiIndex];
                  if (lt_value_equals(itemFirst, v_bool(false))) {
                    sql = lt_buf_append(sql, v_string(","));
                    wsql = lt_buf_append(wsql, v_string(","));
                  }
                  itemFirst = v_bool(false);
                  if (({ ArgumentValue __lt_t = (lt_has(ti, v_string("chain"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
                    tmpRef = isRef(lt_get(lt_get(ti, v_string("chain")), v_string("values")));
                    if (!lt_value_equals(tmpRef, v_string(""))) {
                      emitIdent(tmpRef);
                    }
                    else if ((lt_value_equals(firstKind(lt_get(lt_get(ti, v_string("chain")), v_string("values"))), v_string("select")) || lt_value_equals(firstKind(lt_get(lt_get(ti, v_string("chain")), v_string("values"))), v_string("with"))) || (lt_value_equals(firstKind(lt_get(lt_get(ti, v_string("chain")), v_string("values"))), v_string("values")) || (lt_value_equals(firstKind(lt_get(lt_get(ti, v_string("chain")), v_string("values"))), v_string("insert")) || (lt_value_equals(firstKind(lt_get(lt_get(ti, v_string("chain")), v_string("values"))), v_string("update")) || lt_value_equals(firstKind(lt_get(lt_get(ti, v_string("chain")), v_string("values"))), v_string("delete")))))) {
                      savedSql = sql;
                      savedW = wsql;
                      savedOrderSql = orderSql;
                      savedOrderW = orderW;
              ...
              pushW(v_string("("));
              ArgumentValue itemFirst = v_bool(true);
              ArgumentValue tiArray = valueRows;
              for (size_t tiIndex = 0; tiIndex < tiArray.count; tiIndex++) {
                ArgumentValue ti = ((const ArgumentValue *)tiArray.as.data)[tiIndex];
                if (lt_value_equals(itemFirst, v_bool(false))) {
                  sql = lt_buf_append(sql, v_string(","));
    ...
    for (size_t nodeIndex = 0; nodeIndex < nodeArray.count; nodeIndex++) {
      ...
      if (({ ArgumentValue __lt_t = (lt_has(node, v_string("functionCall"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
        if (lt_value_equals(pn, v_string("col")) || lt_value_equals(pn, v_string("table"))) {
          ...
          if (lt_value_equals(first, v_bool(false))) {
          ...
          if (({ ArgumentValue __lt_t = (lt_has(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("chain"))); __lt_t.type == D_NULL ? 0 : (__lt_t.type == D_BOOL || __lt_t.type == D_INT) ? (__lt_t.as.i != 0) : __lt_t.type == D_FLOAT ? (__lt_t.as.f != 0) : __lt_t.type == D_STRING ? (__lt_t.as.s && __lt_t.as.s[0] != 0) : (__lt_t.count != 0); })) {
            if ((lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("chain")), v_string("values"))), v_string("select")) || lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("chain")), v_string("values"))), v_string("with"))) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("chain")), v_string("values"))), v_string("values")) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("chain")), v_string("values"))), v_string("insert")) || (lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("chain")), v_string("values"))), v_string("update")) || lt_value_equals(firstKind(lt_get(lt_get(lt_get(lt_index(lt_get(lt_get(node, v_string("functionCall")), v_string("arguments")), v_int(0)), v_string("argument")), v_string("chain")), v_string("values"))), v_string("delete")))))) {
              ...
              pushSql(v_string("IN ("));
              pushW(v_string("IN ("));
              ArgumentValue inFirst = v_bool(true);
              ...
              for (size_t ivIndex = 0; ivIndex < ivArray.count; ivIndex++) {
                ...
                if (lt_value_equals(inFirst, v_bool(false))) {
                  sql = lt_buf_append(sql, v_string(","));
                  wsql = lt_buf_append(wsql, v_string(","));
                }
                inFirst = v_bool(false);
        ...
        else if (lt_value_equals(pn, v_string("isnotnull"))) {
          if (lt_value_equals(first, v_bool(false))) {
            pushSql(v_string("AND"));
            pushW(v_string("AND"));
          }
          ...
          pushSql(base);
          pushW(base);
          pushSql(v_string("IS NOT NULL"));
          pushW(v_string("IS NOT NULL"));
          hasLeft = v_bool(false);
        }
          ...
          pushSql(v_string("("));
          pushW(v_string("("));
          ArgumentValue boolFirst = v_bool(true);
          ...
          for (size_t bvIndex = 0; bvIndex < bvArray.count; bvIndex++) {
            ...
            if (lt_value_equals(boolFirst, v_bool(false))) {
              tmp = lt_to_upper(pn);
              pushSql(tmp);
              pushW(tmp);
            }
            boolFirst = v_bool(false);
...
static const FunctionSignature query_builder_parse_sig = { "parse", 0, 0, 0, "query-builder" };

#define parse(builder) \
    ({ \
        if (!(builder).schema.chain.typeName || !(strcmp((builder).schema.chain.typeName, "query-builder") == 0)) \
            fail("custom function 'parse' is not a member of structure '%s'", (builder).schema.chain.typeName ? (builder).schema.chain.typeName : "(none)"); \
        query_builder_parse_impl((builder), 0, 0); \
    })
...
static const StructType query_builder_is_null_args[] = {  };
static const StructType query_builder_is_not_null_args[] = {  };
...
static const FunctionSignature query_builder_functions[] = {
    ...
    { "is-null", 0, query_builder_is_null_args, 0, "query-builder" },
    { "is-not-null", 0, query_builder_is_not_null_args, 0, "query-builder" },
